...
КАТЕГОРИИ = [
    "История", "География", "Наука и природа", "Футбол", "Технологии", "Литература", "Световна кухня",
    "Митология и легенди", "Видеоигри", "Музика през десетилетията", "Космос и астрономия", "Известни цитати", "Световни рекорди",
    "Изкуство и култура", "Мода и стил", "Философия", "Медии и журналистика",
    "Здраве и фитнес", "История на изкуствата", "Фантастика и научна фантастика", "Религии и вярвания", "Известни Изобретения", "Социални мрежи",
    "Животни и животински свят", "Архитектура и строителство", "Кино и телевизионни сериали", 
    "Екологични проблеми и устойчиво развитие", "Водни ресурси и океани", "АвтоМото", "Зимни спортове", "Баскетбол", "Олимпийски Спортове",
...
def get_temperature(difficulty):
    # Difficulty levels: "основно ниво", "контекстуално разбиране", etc.
    if difficulty == "основно ниво":
        return max(0.2, 0.3 - (random.random() * 0.1))  # Higher temperature for creativity
    elif difficulty == "контекстуално разбиране":
        return max(0.15, 0.25 - (random.random() * 0.1))
    elif difficulty == "междинно аналитично":
        return max(0.1, 0.2 - (random.random() * 0.1))
    else:
        return max(0.05, 0.2 - (random.random() * 0.1))  # Lower temperature for precision

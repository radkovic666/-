...
► Основно ниво: Директни факти с един очевиден верен отговор. Пример: „Коя е столицата на Франция?“
► Контекстуално разбиране: Изисква интерпретация на информация. Пример: „Кой от тези исторически личности е известен с реформите си в образованието?“
► Междинно аналитично: Сравняване на концепции или идеи. Пример: „Коя от тези две изобретения е появила първа?“
► Комплексни връзки: Връзки между различни области. Пример: „Как химичните елементи влияят на климатичните промени?“
► Специфична експертиза: Знания извън общата култура. Пример: „Кой художник е известен с техниката си на точково рисуване?“
► Критичен анализ: Противоречиви мнения или сложни теми. Пример: „Кое от тези твърдения най-добре описва ефекта на социалните мрежи върху обществото?“
► Мултидисциплинарно: Интеграция на концепции от различни области. Пример: „Как физиката и биологията се преплитат в изучаването на космоса?“
► Научно изследователско: Последни открития или сложни научни теми. Пример: „Кое от тези открития е най-новата стъпка в изследването на черните дупки?“
